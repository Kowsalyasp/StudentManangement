...
/**
* <h1>Student, View!</h1>
* The StudentView program implements an application that
* simply displays "User input".
*/
...
public class StudentView {
	...
	public Date getDoB() throws ParseException {
		...
		Date dob=StudentValidation.getDoBValidation(date);
		return dob;
	}
	 ...
	 * @param map
	 */
	public void viewAllStudents(Map<Integer, Student> map) {
	 ...
	 * @param show
	 */
	public void viewStudent(Student show) {
